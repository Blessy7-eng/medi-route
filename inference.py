...
# ---------------------------------------------------
# 4. Evaluation Logic (Mandatory for Phase 2 Logs)
# ---------------------------------------------------
...
# ---------------------------------------------------
# 5. API Endpoints (Required for Phase 1 & 2)
# ---------------------------------------------------
...
@app.post("/reset")
def reset():
    if env_api is None: return {"error": "Environment not initialized"}
...
# ---------------------------------------------------
# 6. Execution Block (THE PORT CONFLICT FIX)
# ---------------------------------------------------
if __name__ == "__main__":
    import uvicorn
    
    # 1. Generate logs first to satisfy the grader
    ...
    try:
        # reload=False and workers=1 are CRITICAL to stop Errno 98
        uvicorn.run(
            app, 
            host="0.0.0.0", 
            port=port, 
